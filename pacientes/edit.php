...
if($_SESSION['logado'] && $_SESSION['sts_usuario']) {
      ...
      if($conn->connect_error) {
          ...
          if($_SERVER["REQUEST_METHOD"] == "POST") { 
            ...
            bai_paciente='$bai_paciente',
            com_paciente='$com_paciente',
            cep_paciente='$cep_paciente',
            cid_paciente='$cid_paciente',
            uf_paciente='$uf_paciente',
            dtn_paciente='$dtn_paciente',
            fone_paciente='$fone_paciente',
            email_paciente='$email_paciente',
            pes_paciente='$pes_paciente',
            alt_paciente='$alt_paciente',
            fuma_paciente='$fuma_paciente',
            bebe_paciente='$bebe_paciente',
            hiper_paciente='$hiper_paciente',
            diab_paciente='$diab_paciente',
            dac_paciente='$dac_paciente',
            doe_paciente='$doe_paciente',
            med_paciente='$med_paciente',
            rem_paciente='$rem_paciente'
            ...
            if($conn->query($sql) === TRUE) {
              ...
              <div class="alert alert-success" role="alert">
                ...
                Paciente editado com sucesso!</h2>
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Editando paciente</h1>
  </div>
  <form method="post" action="main.php?p=pacientes/edit.php">
  <div class="mb-3">
    <label class="form-label">Código paciente</label>
    <input type="text" class="form-control" id="cod_paciente" name="cod_paciente" value="<?=$dados[0];?>" readonly>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="nom_paciente" name="nom_paciente" maxlength="40" value="<?=$dados[1];?>">
  </div>
  <div class="mb-3">
  <label for="sex_paciente" class="form-label">Sexo</label>
    <select class="form-select" id="sex_paciente" name="sex_paciente" value="<?=$dados[2];?>">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="end_paciente" name="end_paciente" maxlength="40" value="<?=$dados[3];?>">
  </div>
  <div class="mb-3">
    <label for="bai_paciente" class="form-label">Bairro</label>
    <input type="text" class="form-control" id="bai_paciente" name="bai_paciente" maxlength="25" value="<?=$dados[4];?>">
  </div>
  <div class="mb-3">
    <label for="com_paciente" class="form-label">Complemento</label>
    <input type="text" class="form-control" id="com_paciente" name="com_paciente" maxlength="15" value="<?=$dados[5];?>">
  </div>  
  <div class="mb-3">
    <label for="cep_paciente" class="form-label">Cep</label>
    <input type="text" class="form-control" id="cep_paciente" name="cep_paciente" maxlength="8" value="<?=$dados[6];?>">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="cid_paciente" name="cid_paciente" maxlength="35" value="<?=$dados[7];?>">
  </div>
  <div class="mb-3">
    <label for="uf_paciente" class="form-label">UF</label>
    <input type="text" class="form-control" id="uf_paciente" name="uf_paciente" maxlength="2" value="<?=$dados[8];?>">
  </div>
  <div class="mb-3">
    <label for="dtn_paciente" class="form-label">Data de nascimento</label>
    <input type="date" class="form-control" id="dtn_paciente" name="dtn_paciente" value="<?=$dados[9];?>">
  </div>
  <div class="mb-3">
    <label for="fone_paciente" class="form-label">Telefone</label>
    <input type="text" class="form-control" id="fone_paciente" name="fone_paciente" maxlength="10" placeholder="" value="<?=$dados[10];?>">
    <div id="helpTelPaciente" class="form-text">
    Não utilizar traços ou qualquer tipo de caractere diferente de números.
    </div>
  </div>
  <div class="mb-3">
    ...
    <input type="email" class="form-control" id="email_paciente" name="email_paciente" maxlength="50" value="<?=$dados[11];?>">
  </div>
  <div class="mb-3">
    <label for="pes_paciente" class="form-label">Peso</label>
    <input type="number" class="form-control" id="pes_paciente" name="pes_paciente" step=".01" value="<?=$dados[12];?>">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" id="alt_paciente" name="alt_paciente" step=".01" value="<?=$dados[13];?>">
  ...
  <label for="fuma_paciente" class="form-label">Fuma</label>
    <select class="form-select" id="fuma_paciente" name="fuma_paciente" value="<?=$dados[14];?>">
  ...
  <label for="bebe_paciente" class="form-label">Bebe</label>
    <select class="form-select" id="bebe_paciente" name="bebe_paciente" value="<?=$dados[15];?>">
        <option value="0">Não</option>
        <option value="1">Sim</option>
    </select>
  </div>
  ...
  <label for="hiper_paciente" class="form-label">Hipertenso</label>
    <select class="form-select" id="hiper_paciente" name="hiper_paciente" value="<?=$dados[16];?>">
        <option value="0">Não</option>
        <option value="1">Sim</option>
    </select>
  </div>
  ...
  <label for="diab_paciente" class="form-label">Diabético</label>
    <select class="form-select" id="diab_paciente" name="diab_paciente" value="<?=$dados[17];?>">
        <option value="0">Não</option>
        <option value="1">Sim</option>
    </select>
  </div>
  ...
  <label for="dac_paciente" class="form-label">Doença arterial coronariana</label>
    <select class="form-select" id="dac_paciente" name="dac_paciente" value="<?=$dados[18];?>">
        <option value="0">Não</option>
        <option value="1">Sim</option>
    </select>
  </div>
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="doe_paciente" name="doe_paciente" maxlength="100" value="<?=$dados[19];?>">
  </div>
  <div class="mb-3">
  <label for="med_paciente" class="form-label">Toma remédio</label>
    <select class="form-select" id="med_paciente" name="med_paciente" value="<?=$dados[20];?>">
        <option value="0">Não</option>
        <option value="1">Sim</option>
    </select>
  </div>
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="rem_paciente" name="rem_paciente" maxlength="100" value="<?=$dados[21];?>">
  </div>

  <button type="submit" class="btn btn-success">Salvar</button>
  <?php echo "<td><a href='main.php?p=pacientes/detalhes.php&id=".$dados[0]."' class='btn btn-secondary'>Cancelar</a></tr>" ?>
  </form
  <br><br><br>
